...
UBUNTU_TRANSLATION_DOMAIN="expandablescolumn.liu-xiao-guo"
...
aptest.commands = bash $$PWD/expandablescolumn/tests/autopilot/run
aptest.depends  = sub-expandablescolumn

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/expandablescolumn/tests/unit
unittest.depends  = sub-expandablescolumn
